...
// --- migrations: add columns that may not exist on a pre-existing database file ---
...
safeAddColumn("proposal_requests", "document_url TEXT");
safeAddColumn("proposal_requests", "template_id INTEGER REFERENCES proposal_templates(id)");
